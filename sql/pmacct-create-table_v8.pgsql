...
-- $ psql -d pmacct -f pmacct-create-table_v8.pgsql
--
...
CREATE TABLE acct_v8 (
    ...
    CONSTRAINT acct_v8_pk PRIMARY KEY (agent_id, class_id, mac_src, mac_dst, vlan, as_src, as_dst, ip_src, ip_dst, port_src, port_dst, ip_proto, tos, stamp_inserted)
);
...
-- Perms
GRANT SELECT, INSERT, UPDATE, DELETE ON acct_v8 TO pmacct;
