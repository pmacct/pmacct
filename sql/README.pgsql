...
- Aggregation primitives to SQL schema mapping. Although default schemas
  ...
  * vrf_name => vrf_name (CHAR(32) NOT NULL DEFAULT ' ')
  * ingress_vrf_name => vrf_name_ingress (CHAR(32) NOT NULL DEFAULT ' ')
  * egress_vrf_name => vrf_name_egress (CHAR(32) NOT NULL DEFAULT ' ')
