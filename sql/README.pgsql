...
- Aggregation primitives to SQL schema mapping. Although default schemas
  ...
  * peer_src_ip => peer_ip_src (inet NOT NULL DEFAULT '0.0.0.0')
  * peer_dst_ip => peer_ip_dst (inet NOT NULL DEFAULT '0.0.0.0')
  * mpls_vpn_rd => mpls_vpn_rd (CHAR(18) NOT NULL DEFAULT ' ')
  * vrf_name => vrf_name (VARCHAR(32) NOT NULL DEFAULT ' ')
  * ingress_vrf_name => vrf_name_ingress (VARCHAR(32) NOT NULL DEFAULT ' ')
  * egress_vrf_name => vrf_name_egress (VARCHAR(32) NOT NULL DEFAULT ' ')
  ...
  * in_iface_name => iface_name_in (VARCHAR(32) NOT NULL DEFAULT ' ')
  * out_iface_name => iface_name_out (VARCHAR(32) NOT NULL DEFAULT ' ')
  ...
  * dst_host => ip_dst (inet NOT NULL DEFAULT '0.0.0.0')
  * src_net => net_src (inet NOT NULL DEFAULT '0.0.0.0')
  * dst_net => net_dst (inet NOT NULL DEFAULT '0.0.0.0')
  ...
  * post_nat_src_host => post_nat_ip_src (inet NOT NULL DEFAULT '0.0.0.0')
  * post_nat_dst_host => post_nat_ip_dst (inet NOT NULL DEFAULT '0.0.0.0')
  ...
  * tunnel_src_host => tunnel_ip_src (inet NOT NULL DEFAULT '0.0.0.0')
  * tunnel_dst_host => tunnel_ip_dst (inet NOT NULL DEFAULT '0.0.0.0')
