...
EXT int cfg_key_sfacctd_counter_kafka_fallback(char *, char *, char *);
...
EXT int cfg_key_telemetry_msglog_kafka_fallback(char *, char *, char *);
...
EXT int cfg_key_telemetry_dump_kafka_fallback(char *, char *, char *);
...
EXT int cfg_key_nfacctd_bgp_msglog_kafka_fallback(char *, char *, char *);
...
EXT int cfg_key_nfacctd_bgp_table_dump_kafka_fallback(char *, char *, char *);
...
EXT int cfg_key_nfacctd_bmp_msglog_kafka_fallback(char *, char *, char *);
...
EXT int cfg_key_nfacctd_bmp_dump_kafka_fallback(char *, char *, char *);
