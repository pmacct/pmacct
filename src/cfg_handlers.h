...
EXT int cfg_key_networks_no_mask_if_zero(char *, char *, char *);
...
EXT int cfg_key_nfacctd_disable_opt_scope_check(char *, char *, char *);
...
EXT int cfg_key_nfacctd_kafka_broker_host(char *, char *, char *);
EXT int cfg_key_nfacctd_kafka_broker_port(char *, char *, char *);
...
EXT int cfg_key_telemetry_zmq_address(char *, char *, char *);
...
EXT int cfg_key_classifier_ndpi_idle_scan_period(char *, char *, char *);
EXT int cfg_key_classifier_ndpi_idle_max_time(char *, char *, char *);
EXT int cfg_key_classifier_ndpi_idle_scan_budget(char *, char *, char *);
EXT int cfg_key_classifier_ndpi_giveup_proto_tcp(char *, char *, char *);
EXT int cfg_key_classifier_ndpi_giveup_proto_udp(char *, char *, char *);
EXT int cfg_key_classifier_ndpi_giveup_proto_other(char *, char *, char *);
...
EXT int cfg_key_nfprobe_ifindex_override(char *, char *, char *);
...
EXT int cfg_key_nfacctd_bgp_disable_router_id_check(char *, char *, char *);
...
EXT int cfg_key_bgp_xconnect_map(char *, char *, char *);
...
EXT int cfg_key_rpki_rtr_cache(char *, char *, char *);
EXT int cfg_key_rpki_rtr_cache_version(char *, char *, char *);
EXT int cfg_key_rpki_rtr_cache_pipe_size(char *, char *, char *);
EXT int cfg_key_rpki_rtr_cache_ip_precedence(char *, char *, char *);
