...
#define COUNT_INT_SEQUENCE_NUMBER	0x0002000000010000ULL
#define COUNT_INT_VERSION		0x0002000000020000ULL
...
#define COUNT_SEQUENCE_NUMBER		(COUNT_INT_SEQUENCE_NUMBER & COUNT_REGISTRY_MASK)
#define COUNT_VERSION			(COUNT_INT_VERSION & COUNT_REGISTRY_MASK)
