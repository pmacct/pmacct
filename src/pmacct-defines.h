...
/* INTERNAL METRICS DEFINITION: START */
#define METRICS_INT_PLUGIN_QUEUES_TOT_SZ        0x0001000000000001ULL
#define METRICS_INT_PLUGIN_QUEUES_USED_SZ	0x0001000000000002ULL
#define METRICS_INT_PLUGIN_QUEUES_USED_CNT	0x0001000000000004ULL
#define METRICS_INT_PLUGIN_QUEUES_FILL_RATE	0x0001000000000008ULL
#define METRICS_INT_NFACCTD_RCV_PKT		0x0001000000000010ULL
#define METRICS_INT_NFACCTD_TPL_CNT		0x0001000000000020ULL
#define METRICS_INT_NFACCTD_UDP_TX_QUEUE 	0x0001000000000040ULL
#define METRICS_INT_NFACCTD_UDP_RX_QUEUE 	0x0001000000000080ULL
#define METRICS_INT_NFACCTD_UDP_APP_DROP_CNT	0x0001000000000100ULL
#define METRICS_INT_NFACCTD_UDP_SOCK_DROP_CNT   0x0001000000000200ULL
#define METRICS_INT_KAFKA_FLUSH_CNT		0x0001000000000400ULL
#define METRICS_INT_KAFKA_FLUSH_MSG_SENT	0x0001000000000800ULL
#define METRICS_INT_KAFKA_FLUSH_MSG_ERR		0x0001000000001000ULL
#define METRICS_INT_KAFKA_FLUSH_TIME		0x0001000000002000ULL
