...
#define COUNT_INT_IN_IFACE_NAME		0x0003000000000200ULL
#define COUNT_INT_OUT_IFACE_NAME	0x0003000000000400ULL
...
#define COUNT_IN_IFACE_NAME		(COUNT_INT_IN_IFACE_NAME & COUNT_REGISTRY_MASK)
#define COUNT_OUT_IFACE_NAME		(COUNT_INT_OUT_IFACE_NAME & COUNT_REGISTRY_MASK)
...
#define NF_NET_IGP	0x00000010 /* Determine IP network prefixes from IGP / BGP-LS */
#define NF_NET_BGP_LS	NF_NET_IGP
