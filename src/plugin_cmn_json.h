...
EXT void compose_json_tunnel_src_mac(json_t *, struct chained_cache *);
EXT void compose_json_tunnel_dst_mac(json_t *, struct chained_cache *);
...
EXT void compose_json_tunnel_src_port(json_t *, struct chained_cache *);
EXT void compose_json_tunnel_dst_port(json_t *, struct chained_cache *);
