...
EXT void compose_json_src_host_lat(json_t *, struct chained_cache *);
EXT void compose_json_dst_host_lat(json_t *, struct chained_cache *);
EXT void compose_json_src_host_lon(json_t *, struct chained_cache *);
EXT void compose_json_dst_host_lon(json_t *, struct chained_cache *);
#endif
