...
EXT int bgp_attr_parse(struct bgp_peer *, void *, char *, int, struct bgp_nlri *, struct bgp_nlri *);
...
EXT int bgp_process_update(struct bgp_peer *, struct prefix *, void *, afi_t, safi_t);
