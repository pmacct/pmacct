...
EXT void handle_dynname_internal_strings(char *, int, char *, struct primitives_ptrs *, int);
EXT void handle_dynname_internal_strings_same(char *, int, char *, struct primitives_ptrs *, int);
