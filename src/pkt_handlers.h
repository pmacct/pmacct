...
EXT void src_host_lon_geoipv2_handler(struct channels_list_entry *, struct packet_ptrs *, char **);
EXT void dst_host_lon_geoipv2_handler(struct channels_list_entry *, struct packet_ptrs *, char **);
#endif
