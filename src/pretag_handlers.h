...
extern int PT_map_index_entries_ip_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_input_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_output_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_bgp_nexthop_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_src_as_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_dst_as_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_peer_src_as_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_peer_dst_as_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_mpls_vpn_id_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_mpls_vpn_rd_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_mpls_pw_id_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_mpls_label_bottom_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_src_mac_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_dst_mac_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_vlan_id_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_cvlan_id_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_src_net_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_dst_net_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_is_multicast_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_fwd_status_handler(struct id_table_index *, pm_hash_serial_t *, void *);
extern int PT_map_index_entries_null_handler(struct id_table_index *, pm_hash_serial_t *, void *);
...
extern int PT_map_index_fdata_null_handler(struct id_entry *, pm_hash_serial_t *, void *);
