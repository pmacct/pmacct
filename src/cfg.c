...
static const struct _dictionary_line dictionary[] = {
  ...
  {"bgp_daemon_msglog_avro_schema_file", cfg_key_nfacctd_bgp_msglog_avro_schema_file},
  ...
  {"bgp_daemon_msglog_kafka_avro_schema_registry", cfg_key_nfacctd_bgp_msglog_kafka_avro_schema_registry},
  ...
  {"bgp_src_roa_type", cfg_key_nfacctd_bgp_src_roa_type},
  ...
  {"bgp_table_dump_avro_schema_file", cfg_key_nfacctd_bgp_table_dump_avro_schema_file},
  ...
  {"bgp_table_dump_kafka_avro_schema_registry", cfg_key_nfacctd_bgp_table_dump_kafka_avro_schema_registry},
  ...
  {"bmp_daemon_msglog_avro_schema_file", cfg_key_nfacctd_bmp_msglog_avro_schema_file},
  ...
  {"bmp_daemon_msglog_kafka_avro_schema_registry", cfg_key_nfacctd_bmp_msglog_kafka_avro_schema_registry},
  ...
  {"bmp_dump_avro_schema_file", cfg_key_nfacctd_bmp_dump_avro_schema_file},
  ...
  {"bmp_dump_kafka_avro_schema_registry", cfg_key_nfacctd_bmp_dump_kafka_avro_schema_registry},
