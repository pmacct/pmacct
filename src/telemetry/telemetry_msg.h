...
extern int yp_process_subscription_start(struct telemetry_data *, void *, u_int32_t, int);
extern int yp_process_subscription_end(struct telemetry_data *, void *, u_int32_t, int);
