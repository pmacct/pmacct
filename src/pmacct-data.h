...
static const struct _primitives_matrix_struct _primitives_matrix[] = {
  ...
  {"src_host_lat", 1, 1, 1, 1, 0, 0, 0, "Source IP address GeoIP resolution: lattitude"},
  {"dst_host_lat", 1, 1, 1, 1, 0, 0, 0, "Destination IP address GeoIP resolution: lattitude"},
  {"src_host_lon", 1, 1, 1, 1, 0, 0, 0, "Source IP address GeoIP resolution: longitude"},
  {"dst_host_lon", 1, 1, 1, 1, 0, 0, 0, "Destination IP address GeoIP resolution: longitude"},
