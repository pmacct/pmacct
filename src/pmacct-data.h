...
static const struct _primitives_matrix_struct _primitives_matrix[] = {
  ...
  {"peer_src_as", 1, 1, 1, 1, "Source peer ASN"},
  ...
  {"MPLS", 1, 1, 1, 1, ""}, 
  {"mpls_label_bottom", 0, 0, 1, 0, "Bottom MPLS label"},
  {"mpls_label_top", 0, 0, 1, 0, "Top MPLS label"},
  {"mpls_stack_depth", 0, 0, 1, 0, "MPLS stack depth"},
  {"MISC", 1, 1, 1, 1, ""}, 
  ...
  {"tag2", 1, 1, 1, 1, "Tag #2, as result of pre_tag_map or post_tag evaluation"},
  {"TIME", 1, 1, 1, 1, ""}, 
