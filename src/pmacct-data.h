...
static const struct _dictionary_line dictionary[] = {
  ...
  {"classifier_ndpi_num_roots", cfg_key_classifier_ndpi_num_roots},
  {"classifier_ndpi_max_flows", cfg_key_classifier_ndpi_max_flows},
  {"classifier_ndpi_proto_guess", cfg_key_classifier_ndpi_proto_guess},
  {"classifier_ndpi_idle_scan_period", cfg_key_classifier_ndpi_idle_scan_period},
  {"classifier_ndpi_idle_max_time", cfg_key_classifier_ndpi_idle_max_time},
  {"classifier_ndpi_idle_scan_budget", cfg_key_classifier_ndpi_idle_scan_budget},
  {"classifier_ndpi_giveup_proto_tcp", cfg_key_classifier_ndpi_giveup_proto_tcp},
  {"classifier_ndpi_giveup_proto_udp", cfg_key_classifier_ndpi_giveup_proto_udp},
  {"classifier_ndpi_giveup_proto_other", cfg_key_classifier_ndpi_giveup_proto_other},
