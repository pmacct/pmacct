...
static const struct _primitives_matrix_struct _primitives_matrix[] = {
  ...
  {"tag", 1, 1, 1, 1, "Tag, as result of pre_tag_map or post_tag evaluation"},
  {"tag2", 1, 1, 1, 1, "Tag #2, as result of pre_tag_map or post_tag2 evaluation"},
  {"TIME", 1, 1, 1, 1, ""}, 
...
static const struct _dictionary_line dictionary[] = {
  ...
  {"log_amqp_host", cfg_key_log_amqp_host},
  {"log_amqp_user", cfg_key_log_amqp_user},
  {"log_amqp_passwd", cfg_key_log_amqp_passwd},
  {"log_amqp_exchange", cfg_key_log_amqp_exchange},
  {"log_amqp_exchange_type", cfg_key_log_amqp_exchange_type},
  {"log_amqp_routing_key", cfg_key_log_amqp_routing_key},
  {"log_amqp_persistent_msg", cfg_key_log_amqp_persistent_msg},
  {"log_amqp_retry", cfg_key_log_amqp_retry},
