...
static const struct _primitives_matrix_struct _primitives_matrix[] = {
  ...
  {"L2", 1, 1, 1, 1, 0, ""}, 
  {"cos", 1, 0, 1, 1, 0, "Ethernet CoS, 802.1P"},
  {"etype", 1, 0, 1, 1, 0, "Ethernet Ethertype"},
  {"src_mac", 1, 1, 1, 1, 0, "Source MAC address"},
  {"dst_mac", 1, 1, 1, 1, 0, "Destination MAC address"},
  {"vlan", 1, 1, 1, 1, 0, "Ethernet VLAN, 802.1Q"},
  {"L3", 1, 1, 1, 1, 0, ""}, 
  {"src_host", 1, 1, 1, 1, 0, "Source IPv4/IPv6 address"}, 
  {"dst_host", 1, 1, 1, 1, 0, "Destination IPv4/IPv6 address"},
  {"src_mask", 1, 1, 1, 1, 0, "Source network mask"},
  {"dst_mask", 1, 1, 1, 1, 0, "Destination network mask"},
  {"src_net", 1, 1, 1, 1, 0, "Source IPv4/IPv6 prefix"},
  {"dst_net", 1, 1, 1, 1, 0, "Destination IPv4/IPv6 prefix"},
  {"proto", 1, 1, 1, 1, 0, "IP protocol"},
  {"tos", 1, 1, 1, 1, 0, "IP ToS"},
  {"L4", 1, 1, 1, 1, 0, ""}, 
  {"src_port", 1, 1, 1, 1, 0, "Source TCP/UDP port"},
  {"dst_port", 1, 1, 1, 1, 0, "Destination TCP/UDP port"},
  {"tcpflags", 1, 1, 1, 1, 0, "TCP flags"},
  {"BGP", 1, 1, 1, 1, 0, ""}, 
  {"src_as", 1, 1, 1, 1, 0, "Source ASN"},
  {"dst_as", 1, 1, 1, 1, 0, "Destination ASN"},
  {"as_path", 1, 1, 1, 1, 0, "AS PATH"},
  {"std_comm", 1, 1, 1, 1, 0, "Standard Communities"},
  {"ext_comm", 1, 1, 1, 1, 0, "Extended Communities"},
  {"local_pref", 1, 1, 1, 1, 0, "Local Preference"},
  {"med", 1, 1, 1, 1, 0, "Multi-Exit Discriminator"},
  {"src_as_path", 1, 1, 1, 1, 0, "Source AS PATH (via reverse BGP lookup)"},
  {"src_std_comm", 1, 1, 1, 1, 0, "Source Standard Communities (via reverse BGP lookup)"},
  {"src_ext_comm", 1, 1, 1, 1, 0, "Source Extended Communities (via reverse BGP lookup)"},
  {"src_local_pref", 1, 1, 1, 1, 0, "Source Local Preference (by default via reverse BGP lookup)"},
  {"src_med", 1, 1, 1, 1, 0, "Source MED (by default via reverse BGP lookup)"},
  {"mpls_vpn_rd", 0, 0, 1, 1, 0, "MPLS VPN Route Distinguisher"},
  {"peer_src_as", 1, 1, 1, 1, 0, "Source peer ASN (by default via reverse BGP lookup)"},
  {"peer_dst_as", 1, 1, 1, 1, 0, "Destination peer ASN"},
  {"peer_dst_ip", 1, 1, 1, 1, 0, "BGP next-hop"},
  {"NAT", 1, 1, 1, 1, 0, ""}, 
  {"fw_event", 0, 0, 1, 0, 0, "Firewall event ID"},
  {"nat_event", 0, 0, 1, 0, 0, "NAT event ID"},
  {"post_nat_src_host", 0, 0, 1, 0, 0, "Source IPv4/IPv6 address after NAT translation"},
  {"post_nat_dst_host", 0, 0, 1, 0, 0, "Destination IPv4/IPv6 address after NAT translation"},
  {"post_nat_src_port", 0, 0, 1, 0, 0, "Source TCP/UDP port after NAT translation"},
  {"post_nat_dst_port", 0, 0, 1, 0, 0, "Destination TCP/UDP port after NAT translation"},
  {"MPLS", 1, 1, 1, 1, 0, ""}, 
  {"mpls_label_bottom", 1, 1, 1, 0, 0, "Bottom MPLS label"},
  {"mpls_label_top", 1, 1, 1, 0, 0, "Top MPLS label"},
  {"mpls_stack_depth", 1, 1, 1, 0, 0, "MPLS stack depth"},
  {"MISC", 1, 1, 1, 1, 0, ""}, 
  {"class", 1, 1, 1, 1, 0, "L7 protocol classification"},
  {"flows", 0, 0, 1, 0, 0, "IP flows"},
  {"src_host_country", 1, 1, 1, 1, 0, "Source IP address GeoIP resolution: country"},
  {"dst_host_country", 1, 1, 1, 1, 0, "Destination IP address GeoIP resolution: country"},
  {"in_iface", 0, 1, 1, 1, 0, "Input interface, SNMP ifIndex"}, 
  {"out_iface", 0, 1, 1, 1, 0, "Output interface, SNMP ifIndex"}, 
  {"peer_src_ip", 0, 0, 1, 1, 0, "IP address or identificator of telemetry exporting device"},
  {"pkt_len_distrib", 1, 1, 1, 1, 0, "Packet length distribution"},
  {"sampling_rate", 1, 1, 1, 1, 0, "Sampling rate"},
  {"tag", 1, 1, 1, 1, 0, "Numeric tag, ie. as result of pre_tag_map evaluation"},
  {"tag2", 1, 1, 1, 1, 0, "Numeric tag, ie. as result of pre_tag_map evaluation"},
  {"label", 1, 1, 1, 1, 0, "String label, ie. as result of pre_tag_map evaluation"},
  {"export_proto_seqno", 0, 0, 1, 1, 0, "Export protocol (ie. NetFlow) sequence number"},
  {"export_proto_version", 0, 0, 1, 1, 0, "Export protocol (ie. NetFlow) version"},
  {"TIME", 1, 1, 1, 1, 0, ""}, 
